      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-xl text-mind-content-secondary max-w-2xl mx-auto leading-relaxed tracking-tight">
            Schedule a free consultation and see how I can help your organization
          </p>
        </div>
              ...
              <div className="space-y-8">
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    />
                    <div id="email-help" className="sr-only">Enter your email address for contact</div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell me about your hiring challenges..."
                  />
                  <div id="message-help" className="sr-only">Describe your hiring needs and challenges</div>
                </div>
