...
+        <div className="grid md:grid-cols-3 gap-6 mb-12">
           {problems.map((problem, index) => {
             ...
             return (
               <div
                 key={index}
-                className={`bg-mind-surface-bg-grey rounded-2xl p-8 border border-gray-100 transition-all duration-700 ${
...
-                <h3 className="text-xl font-bold text-mind-content-primary mb-4 leading-tight">
+                <h3 className="text-lg font-bold text-mind-content-primary mb-3 leading-tight">
                   {problem.title}
                 </h3>
                 
-                <p className="text-mind-content-secondary leading-relaxed">
...
-          <div className="bg-mind-content-primary text-white p-8 md:p-12 rounded-3xl">
