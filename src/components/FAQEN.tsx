...
const faqItems = [
  {
    question: "Why are Polish developers in such high demand?",
    videoId: "dQw4w9WgXcQ" // Placeholder YouTube video ID
  },
  {
    question: "How does the B2B contract model work?",
    videoId: "dQw4w9WgXcQ" // Placeholder YouTube video ID
  },
  {
    question: "What are your fees compared to big agencies?",
    videoId: "dQw4w9WgXcQ" // Placeholder YouTube video ID
  },
  {
    question: "Can you help with relocation?",
    videoId: "dQw4w9WgXcQ" // Placeholder YouTube video ID
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className={`text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-xl text-mind-content-secondary max-w-3xl mx-auto leading-relaxed tracking-tight">
            Get straight answers about Tech Recruitment in Poland.
          </p>
        </div>
