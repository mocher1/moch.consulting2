...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[75vh] bg-gradient-to-br from-mind-warm-white via-white to-mind-light-grey flex items-center justify-center px-6 overflow-hidden">
