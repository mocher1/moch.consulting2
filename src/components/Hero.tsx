      ...
      <div className="relative max-w-5xl mx-auto text-center">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h1 className="text-5xl md:text-7xl font-semibold text-mind-content-primary mb-8 leading-tight tracking-tight">
            Strategiczne usługi HR, dopasowane do potrzeb{' '}
          ...
          <p className="text-xl md:text-2xl text-mind-content-secondary mb-12 leading-relaxed max-w-3xl mx-auto tracking-tight">
            Od strategii i procesów po kluczowe rekrutacje – wspieram firmy w budowaniu efektywnego HR.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button 
              ...
              aria-label="Umów bezpłatną konsultację HR"
            ...
            <button 
              ...
              aria-label="Poznaj szczegóły moich usług HR"
