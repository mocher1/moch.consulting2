...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[50vh] bg-gradient-to-br from-mind-warm-white via-white to-mind-light-grey flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto text-center z-10 pt-16 pb-16">
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-lg md:text-xl text-mind-content-secondary/90 mb-5 leading-relaxed max-w-4xl mx-auto font-medium">
